...
%             obj.add_surface_with_alpha(qb_axle, [0.15 0.15 0.15], 0.5);
        ...
        function ir_distances = get_ir_distances(obj)
            ...
            Distance = [0.04,0.05,0.06,0.07,0.08,0.09,0.10,0.12,0.14,0.16,0.18,0.20,0.25,0.30];
            Voltage = [2.75,2.35,2.05,1.75,1.55,1.4,1.275,1.075,0.925,0.805,0.725,0.65,0.5,0.4];
            coeff = polyfit(Voltage,Distance,5);
